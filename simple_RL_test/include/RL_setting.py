...
class RL():
    def __init__(self):
        ...
        self.dt = 0.1
        self.init_state = [0, -self.course_radius, 0, 0] # x, y, vel, heading

        self.env = car_env.CarEnv(self.dt, self.init_state, self.course_center, self.course_radius)
    ...
    def test_agent(self, n_simulation_steps):
        ...
        for step in range(n_simulation_steps):
            ...
            acc, steering = self.env.action_list(action, ACC_const, Steering_const)
